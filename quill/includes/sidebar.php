  <div class="col-md-4" style = "background-color: beige;">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Search for..." style = "background-color: beige;" required>
                <span class="input-group-btn" style = "background-color: beige;">
