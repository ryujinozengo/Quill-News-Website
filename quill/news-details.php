...
<!---Comment Section --->
 ...
 <div class="row" style="margin-top: -8%">
   <div class="col-md-8" style = "background-color: beige;">
<div class="card my-4" style = "background-color: beige;">
            <h5 class="card-header">Leave a Comment:</h5>
            <div class="card-body">
              <form name="Comment" method="post">
      <input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['token']); ?>" />
 <div class="form-group" style = "background-color: beige;">
<input type="text" name="name" class="form-control" placeholder="Enter your fullname" style = "background-color: beige;" required>
</div>

 <div class="form-group" style = "background-color: beige;">
 <input type="email" name="email" class="form-control" placeholder="Enter your Valid email" style = "background-color: beige;" required>
 </div>


                <div class="form-group" style = "background-color: beige;">
                  <textarea class="form-control" name="comment" rows="3" placeholder="Comment" style = "background-color: beige;" required></textarea>
                </div>
...
while ($row=mysqli_fetch_array($query)) {
?>
<div class="media mb-4" style = "background-color: beige;">
            <img class="d-flex mr-3 rounded-circle" src="images/usericon.png" alt="" style = "background-color: beige;">
            <div class="media-body" style = "background-color: beige;">
